...
def pagina2():
    ...
    df_resultados['loss'] = df_resultados['loss'].apply(lambda x: round(x * 100, 2))
    df_resultados['accuracy'] = df_resultados['accuracy'].apply(lambda x: round(x * 100, 2))
    df_resultados['val_loss'] = df_resultados['val_loss'].apply(lambda x: round(x * 100, 2))
    df_resultados['val_accuracy'] = df_resultados['val_accuracy'].apply(lambda x: round(x * 100, 2))
