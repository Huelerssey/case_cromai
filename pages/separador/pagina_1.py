...
def pagina1():
    ...
    with coluna2:
        st.write("")
        st.write("")
        st.markdown("<h5 style='text-align: center;'>🐶 Envie a foto de um Doguinho ou Gatito 🐱</h5>", unsafe_allow_html=True)
    ...
    with coluna2:
        st.write("")
        st.write("")
        st.markdown("<h5 style='text-align: center;'>Veja a mágica acontecer! 🌈🦄</h5>", unsafe_allow_html=True)
